package com.example.arnold.myapp.activity;
...
import com.example.arnold.myapp.db.ORMLightHelper;
import com.example.arnold.myapp.db.model.Actor;
import com.example.arnold.myapp.db.model.Movie;
import com.j256.ormlite.android.apptools.OpenHelperManager;

import java.sql.SQLException;
import java.util.List;

import static android.app.ListActivity.*;
import static com.example.arnold.myapp.activity.ListActivity.ACTOR_KEY;
import static com.example.arnold.myapp.activity.ListActivity.NOTIF_STATUS;
import static com.example.arnold.myapp.activity.ListActivity.NOTIF_TOAST;
...
public class Detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int key = getIntent().getExtras().getInt(ACTOR_KEY);
        ...
        try {
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(Detail.this, m.getmName()+" "+m.getmGenre()+" "+m.getmYear(), Toast.LENGTH_SHORT).show();
